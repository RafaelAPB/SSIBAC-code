...
durations_10_credential.print_all_mean()
...
if "plot3" in arg_list:
    ...
    ax.bar(label, cat, width, yerr=None,
           ...
           label='Connect Alice-IST')
           #label='Alice connects to IST')

    ax.bar(label, emit, width, yerr=None,
           bottom=cat,
           color=viridis.colors[1],
           label='Issue VC to Alice')
           #label='IST issues VC to Alice')
